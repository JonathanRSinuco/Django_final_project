...
class Question(models.Model):
    ...
    def is_get_score(self, selected_ids):
        all_answers = self.choice_set.filter(choiceMark=True).count()
        selected_correct = self.choice_set.filter(
            choiceMark=True, id__in=selected_ids
        ).count()
...
class Choice(models.Model):
    ...
    choiceMark = models.BooleanField()

    def __str__(self):
        return "Name: " + self.choice
